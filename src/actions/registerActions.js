...
import {EMAIL_CHANGEDREG, PASSWORD_CHANGEDREG, LOGIN_USER_SUCCESSREG, LOGIN_USER_FAILREG, LOGIN_USERREG, NAME_CHANGEDREG, DIRECCION_CHANGEDREG, INFO_USER, PHONE_CHANGEDRED} from './types';
